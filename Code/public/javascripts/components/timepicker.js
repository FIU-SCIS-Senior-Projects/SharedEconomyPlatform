...
(function(addon) {
    ...
    UI.component('timepicker', {
        ...
        init: function() {
            ...
            this.options.template  = '<ul class="uk-nav uk-nav-autocomplete uk-autocomplete-results">{{~items}}<li data-value="{{$item.value}}"><a>{{$item.value}}</a></li>{{/items}}<li data-value="Closed"><a>Closed</a></li></ul></ul>';
        ...
        checkTime: function() {
            ...
            if(this.autocomplete.input.val() != "Closed"){
